...
export const ThemeToggle: React.FC = () => {
  ...
  return (
    <button
      ...
      className="relative w-11 h-6 rounded-full bg-gray-200 dark:bg-gray-800 transition-colors duration-300 focus:outline-none focus:ring-1 focus:ring-primary"
